...
allhf=[allhf    hF];
uicontrol(hF,'Style','text','Position',[10,600,120,20],'BackgroundColor',[0,0.9,0],...
'String',{'programm for grafikov'});

tg=uitabgroup(hF,'Position',[10,10,500,300]);
tab1=uitab(tg,'Title','plot','Title','input data');
tab2=uitab(tg,'Title','input data');
